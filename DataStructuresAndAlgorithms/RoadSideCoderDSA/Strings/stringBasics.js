...
const string2 = "Subscribe to RoadsideCoder!"; // double quotes
const string3 = 'RoadsideCoder!'; // single quotes
const string4 = `
Subscribe to ${string3}
Like this Video
Share this video`; // backticks

console.log(string4);


// Template Literals
const $templateLiteral = `Subscribe to ${string3}!`;

// Tagged Literals
console.log`hello ${"world"} how are ${"you"}`

console.log`Hello`; // [ 'Hello' ]
console.log`hello ${"world"} how are ${"you"}`; // [ 'hello ', ' how are ', '' ] world you
...
const youtubeChannel = "RoadsideCoder";
const person = "Piyush";
test`Subscribe to ${youtubeChannel} run by ${person}`;
...
// DataStructuresAndAlgorithms/RoadSideCoderDSA/Strings/stringBasics.js