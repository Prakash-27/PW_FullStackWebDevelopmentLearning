...
// with the ellipis character "..." so that the length matches the maximum length
...
console.log(truncate("factor", 9));


// DataStructuresAndAlgorithms/RoadSideCoderDSA/Strings/truncateTheString.js
